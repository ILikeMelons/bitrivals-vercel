...
const Navbar = ({user, hideLinks=false, web3=false}) => {
    ...
    return (
        <section id="home" className={isScrollValueMoreThanHeaderHeight ? "transition-all duration-200 nav z-30 active fixed w-full" : "transition-all duration-100 nav z-30 fixed w-full"}>
            <Container className="relative z-10 py-6 transition-all duration-100 nav_inner">
                <div className='w-full text-white'>
                    <div className="flex items-center justify-between lg:justify-start">
                        ...
                        <div className="relative z-10 block top-1 js-navIcon lg:hidden">
                            <div className="relative w-10 h-1 mb-2 transform -skew-x-12 bg-pink"></div>
                            <div className="w-10 h-1 mb-2 transform -skew-x-12 bg-pink"></div>
                            <div className="relative w-10 h-1 mb-2 transform -skew-x-12 bg-pink"></div>
                        </div>
