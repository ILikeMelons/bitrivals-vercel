          ...
          <Container className="relative z-20 flex flex-wrap min-h-screen py-20 font-sans font-semibold text-white pt-28 inner md:pt-0">
            ...
            <ReactModal isOpen={modalState} style={{
              ...
              <div className="relative font-sans text-xs leading-5 md:text-sm">
                ...
                <p className="mb-2">2.2 You are responsible for making all arrangements necessary for you to have access to the Platform. You are also responsible for ensuring that all persons who access the Platform through your internet connection ar</p>
